...
// All implementations should embed UnimplementedDepositServiceServer
...
// UnimplementedDepositServiceServer should be embedded to have forward compatible implementations.
